...
------------------------------------------------------
* Modifications by Jackobo Le Chocobo - 06/2024
* 
* Objective : Save Cartridge Datas to PC only
* 
* - Removed Write/Flash Cartridge Methods
* - Removed DMC Support
* 
*  
* Original author : X-death - V 2.0 03/2022
...
// Hardwaretype = 3;
    ...
    printf(" 3) Master System Mode\n");
    printf(" 4) Flash Memory Detection \n");
    printf(" 5) Exit \n");
